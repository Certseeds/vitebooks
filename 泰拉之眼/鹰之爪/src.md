...
附在这张记录上的通讯文件包括在鹰之爪进入大气层之前, 从船上的第7军团的打击部队捕获的信号. 信号的捕获是偶然的, 以及在当地整个佩图拉博[^9]的部队被动作战的结果. 这个录音, 就像获取它的手段一样, 仍然不为我们军团之外的所有人所知.

帝国之拳的打击部队的兵力估计是三个小队, 分别是伽马斯, 泰奥芬和阿卡德. 所有三个小队都配备侦察装备, 只有轻型武器. 据信, 对战舰的渗透是通过炮艇和微型船体破坏进行的. 任务指挥作为伽马斯小队的一部分融合在打击部队中.
...
>>>
>>> TH-144: <<泰奥芬小队现在进入动脉走廊贝塔. 它正在使用中, 指挥官. 地板有振动. 附近有一个跟踪的单元在移动, 但不在视觉范围内. >>
>>>
>>> GA-739: 接近还是离开?
>>>
>>> TH-144: <<离开. 振动正在减少. >>
...
帝国之拳对鹰之爪的渗透与塔兰南部大陆中心的一次重大但未命名的交战同时发生. 这次交战由泰坦和骑士级战争机器主导, 在当时, 这是自忠诚派的增援部队到达星系以来规模最大的一次. 考虑到参与的有关部队的数量和力量, 如果任何一方在这里取得决定性的胜利, 那么他们都可能能够获得整体的战术优势, 然后获取对整个塔兰的胜利.
...
>>>
>>> GA-739: 兄弟, 在战争中总是要付出代价的.
>>>
>>> TH-144: <<我知道, 伽马斯. 我记得. 法尔[^15]在很远的地方, 但我没有忘记生存的代价. 但我们应该承担这种代价, 而不是凡人. 这是我们的战争, 一场军团的战争. 我们的同类发起的战争, 我们应该为自己的胜利付出代价. >>
>>>
>>> GA-739: 这不是我计划的, 兄弟. 如果主要目标得到满足, 那么这些都不是必需的.
>>>
>>> TH-144: <<如果失败了? >>
>>>
>>> GA-739: 那这艘船坠毁.
...
>>> TH-144: <<那么下面的那些? >>
>>>
>>> GA-739: 没有人活在塔兰上, 兄弟. 只有还没有进入坟墓的死者. 按计划进行装药, 泰奥芬, 引爆器通讯按键由我控制.
>>>
>>> TH-144: <<依你之言, 指挥官 >>.

///***记录访问继续.***///

夺取大型航天器并非易事. 成功控制或清除数千——甚至数万名——人类船员所涉及的部队的数量与征服一座大都市化的城市所需的相似. 结合在密闭和极端敌对环境中的战斗问题, 跳帮任务在帝国军事学说中被很好地命名为致命地带[^16]. 死亡之地[^17].

夺取船只的最常见方法是瞄准主要或次要的舰桥. 缺少有效的指挥元素, 即使是一艘军舰也只是一团漂浮在虚空中的金属. 由于这种脆弱性, 指挥点通常是船上防御最严密的位置. 通过跳帮行动进行夺取或摧毁舰桥, 通常是由专门装备的部队进行缓慢消耗, 或者由具有压倒性实力的精锐部队进行闪电般快速的打击.

试图通过渗透来夺取一艘船是……很少见的. 帝国之拳对鹰之爪的行动表明缺乏合适的力量, 但也存在一定程度的想象力, 而我们以前没有把这种想象归功于多恩的儿子们.
...
>>> GA-739: 兄弟, 你的情况如何?
>>>
>>> AR-502: <<我们有一个问题. 我们正在穿过后脊柱层, 但计划并不准确, 指挥官. 布局完全不同. 我们不得不改道, 唯一的选择是使用上层船员甲板上的通风口. 我们正站在敌人的上方. >>
>>>
>>> GA-739: 敌人的实力是什么?
>>>
>>> AR-502: <<不确定, 但数量可观, 并且他们处于战备状态. 他们可能是人类, 但他们中的许多人是海军军人, 还有数百名聚集的坦克乘员. 我们三次接近被发现. 我们在原始计划上标记为6-7-gamma-2的交道上方的空腔内保持着位置. 这是目前据我所知的. >>
>>>
>>> GA-739: 那里有……通往主要目标的次要动脉通道, 不是……距离您当前位置十米. 你能把你的小队穿过通道吗?
>>>
>>> AR-502: <<敌人的活动是恒定的. 他们的移动在没有规律, 最长的间隔是六秒. >>
>>>
>>> GA-739: 你能往回走, 选择走一条不同的路线吗?
>>>
>>> AR-502: <<我们不能回去. 一个船员群体移动到了我们经过的最后一个地方, 然后……还有另一个问题. >>
>>>
>>> GA-739: 告诉我.
>>>
>>> AR-502: <<在这个区域有机械教的存在, 至少是队列[^19]实力. 死隶机兵[^20]和侍卫斗士[^21]部队, 以及智控军团[^22]分队. 他们处于完全警戒状态, 传感器已启动. >>
>>>
>>> GA-739: 你的建议, 中士? 直言不讳.
>>>
>>> AR-502: <<首先, 我们需要一个视线转移, 指挥官. 需要有些东西去引起他们的注意, 但不会危及任务. 需要一个类似于一个严重的事故. >>
>>>
>>> TH-144: <<我们可以炸掉主舱口输送机的提升机. 让它掉个五十层甲板. 可能造成很大的损害, 但他们应该在至少五十到七十分钟里不会意识到这是故意的. >>
>>>
>>> GA-739: 我的小队可以从我们当前的位置到达输送机竖井. 继续, 阿卡德. 下一步是什么?
>>>
...
>>>
>>> GA-739: 但是从那场战斗中, 他来到我们面前——一场与我们的敌人的战争, 战斗时从未直视他们的眼睛. 这不应该是年轻人学习战斗的摇篮. 它应该是老人去死的地方. 我们去死的地方.
>>>
...
这样的计划需要高度的精确度和勇气, 但是当涉及到帝国之拳时, 这些品质从未受到质疑. 然而, 有一个不言而喻的事实是, 操作越精确和微妙, 就越容易出错.
...
在这一时点, 任务在不损失所有部队的情况下成功的可能性是0.0. 帝国之拳们早就知道这一事实, 但这并不会抑制他们运作的能力. 他们, 就像我们所有人被我们父亲的基因种子抚养长大一样, 不受弱小生物的软弱的束缚.

他们早就知道他们无法存活下去了. 唯一的问题是他们是否还能成功.
...
为了我们的目的, 知道它发生了就足够了. 这种性格上的分裂会在帝国之拳中重演吗? 可以从中获利吗? 这个问题仍然保持开放, 但有一件事是可以肯定的——为了使这种情报对我们的军团有用, 它必须保持未知[^30].
